from mapilio_kit.components.utilities.types_fmt import GPXPoint, GPXPointAngle
from mapilio_kit.components.metadata.exif_metadata_reader import ExifRead
